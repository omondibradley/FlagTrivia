...
import { ContractPolicy, Method, Approval, SignMessagePolicy, SessionPolicies } from '@cartridge/presets';
...
declare class HeadlessAuthenticationError extends Error {
    cause?: Error | undefined;
    constructor(message: string, cause?: Error | undefined);
}
declare class InvalidCredentialsError extends HeadlessAuthenticationError {
    constructor(credentialType: string);
}
declare class HeadlessModeNotSupportedError extends Error {
    constructor(operation: string);
}

declare const EXTERNAL_WALLETS: readonly ["metamask", "rabby", "phantom-evm", "argent", "braavos", "phantom", "base"];
type ExternalWalletType = (typeof EXTERNAL_WALLETS)[number];
...
export { type ControllerError, HeadlessAuthenticationError, HeadlessModeNotSupportedError, InvalidCredentialsError, NotReadyToConnect, type SessionOptions, SessionProvider as default };
