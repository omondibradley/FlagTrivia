(function (factory) {
    ...
    function fromBig(n, le = false) {
        if (le) {
            return { h: Number(n & U32_MASK64), l: Number((n >> consts_js_1.N_32) & U32_MASK64) };
        }
        return {
            h: Number((n >> consts_js_1.N_32) & U32_MASK64) | 0,
    ...
    const toBig = (h, l) => (BigInt(h >>> 0) << consts_js_1.N_32) | BigInt(l >>> 0);
    exports.toBig = toBig;
    // for Shift in [0, 32)
