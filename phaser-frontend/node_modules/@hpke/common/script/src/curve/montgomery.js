...
(function (factory) {
    ...
    function montgomery(curveDef) {
        ...
        const minScalar = is25519 ? consts_js_1.N_2 ** BigInt(254) : consts_js_1.N_2 ** BigInt(447);
        const maxAdded = is25519
            ? BigInt(8) * consts_js_1.N_2 ** BigInt(251) - consts_js_1.N_1
            : BigInt(4) * consts_js_1.N_2 ** BigInt(445) - consts_js_1.N_1;
        ...
        function montgomeryLadder(u, scalar) {
            ...
            for (let t = BigInt(montgomeryBits - 1); t >= consts_js_1.N_0; t--) {
